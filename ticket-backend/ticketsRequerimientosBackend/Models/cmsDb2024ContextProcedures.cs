...
namespace ticketsRequerimientosBackend.Models
{
    ...
    {
        private IcmsDb2024ContextProcedures _procedures;

        public virtual IcmsDb2024ContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new cmsDb2024ContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IcmsDb2024ContextProcedures GetProcedures()
        {
            return Procedures;
        }
        ...
        protected void OnModelCreatingGeneratedProcedures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GenerarAutorizacionResult>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<ObtenerAsignacionUsuarioBodegaResult>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<ObtenerCronoMobilTecnicoResult>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<ObtenerLocalidadesAgenciaResult>().HasNoKey().ToView(null);
            modelBuilder.Entity<ObtenerLocalidadPorProvinciaResult>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<ObtenerNotaEntregaResult>().HasNoKey().ToView(null);
    ...
    public partial class cmsDb2024ContextProcedures : IcmsDb2024ContextProcedures
    {
        private readonly cmsDb2024Context _context;

        public cmsDb2024ContextProcedures(cmsDb2024Context context)
        {
            _context = context;
        }
        ...
        public virtual async Task<int> ActualizarContadorEquipoAsync(string codmaquina, int? contador, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ...
                    Value = contador ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[ActualizarContadorEquipo] @codmaquina, @contador", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<GenerarAutorizacionResult>> GenerarAutorizacionAsync(int? idTicket, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<GenerarAutorizacionResult>("EXEC @returnValue = [dbo].[GenerarAutorizacion] @idTicket", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerAsignacionUsuarioBodegaResult>> ObtenerAsignacionUsuarioBodegaAsync(string ccia, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<ObtenerAsignacionUsuarioBodegaResult>("EXEC @returnValue = [dbo].[ObtenerAsignacionUsuarioBodega] @ccia", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerCronoMobilTecnicoResult>> ObtenerCronoMobilTecnicoAsync(string codtecnico, string codcia, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "codtecnico",
                    Size = 30,
                    Value = codtecnico ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.VarChar,
                },
                new SqlParameter
                {
            ...
            var _ = await _context.SqlQueryAsync<ObtenerCronoMobilTecnicoResult>("EXEC @returnValue = [dbo].[ObtenerCronoMobilTecnico] @codtecnico, @codcia", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerLocalidadesAgenciaResult>> ObtenerLocalidadesAgenciaAsync(string codAg, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "codAg",
                    Size = 40,
                    Value = codAg ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.VarChar,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<ObtenerLocalidadesAgenciaResult>("EXEC @returnValue = [dbo].[ObtenerLocalidadesAgencia] @codAg", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerLocalidadPorProvinciaResult>> ObtenerLocalidadPorProvinciaAsync(int? codprovincia, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "codprovincia",
                    Value = codprovincia ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<ObtenerLocalidadPorProvinciaResult>("EXEC @returnValue = [dbo].[ObtenerLocalidadPorProvincia] @codprovincia", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerNotaEntregaResult>> ObtenerNotaEntregaAsync(int? idTicket, string ccia, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<ObtenerNotaEntregaResult>("EXEC @returnValue = [dbo].[ObtenerNotaEntrega] @idTicket, @ccia", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<ObtenerTicketsRequerimientosResult>> ObtenerTicketsRequerimientosAsync(string codcli, string ccia, int? type, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<ObtenerTicketsRequerimientosResult>("EXEC @returnValue = [dbo].[ObtenerTicketsRequerimientos] @codcli, @ccia, @type", sqlParameters, cancellationToken);
