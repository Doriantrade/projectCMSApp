...
namespace cmsDb2024_System.Models
{
    public partial class cmsDb2024Context : DbContext
    {
        ...
        public virtual DbSet<AsignacionMobilTecnico> AsignacionMobilTecnico { get; set; }
        ...
        public virtual DbSet<IntervalosMantenimiento> IntervalosMantenimiento { get; set; }
        ...
        public virtual DbSet<SettingsGeoLocalizacionMobil> SettingsGeoLocalizacionMobil { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AsignacionMobilTecnico>(entity =>
            {
                entity.ToTable("asignacionMobilTecnico");
            ...
            modelBuilder.Entity<DimDate>(entity =>
            {
                entity.HasKey(e => e.DateKey)
                    .HasName("PK__DimDate__40DF45E3547225F0");
            ...
            {
                entity.HasKey(e => new { e.Codtrandet, e.Codtran })
                    .HasName("PK_entytrandet1_1");
            ...
            modelBuilder.Entity<IntervalosMantenimiento>(entity =>
            {
                entity.HasKey(e => e.IdIntervalo);

                entity.ToTable("intervalosMantenimiento");
            ...
            {
                entity.HasKey(e => e.IdIntervalo)
                    .HasName("PK_intervalosTicket1_1");
            ...
            {
                entity.HasKey(e => e.Codrepbodega)
                    .HasName("PK_prodrepasigna1");
            ...
            modelBuilder.Entity<SettingsGeoLocalizacionMobil>(entity =>
            {
                entity.ToTable("settingsGeoLocalizacionMobil");

                entity.Property(e => e.Id).HasColumnName("id");

                entity.Property(e => e.AproximGeoLocalizacion)
                    .HasColumnType("decimal(10, 2)")
                    .HasColumnName("aproximGeoLocalizacion");

                entity.Property(e => e.Codmac)
                    .HasMaxLength(150)
                    .IsUnicode(false)
                    .HasColumnName("codmac");

                entity.Property(e => e.ColorRutaTrazado)
                    .HasMaxLength(8)
                    .IsUnicode(false)
                    .HasColumnName("colorRutaTrazado");
                ...
                entity.Property(e => e.HorarioLabofinal)
                    .HasColumnType("time(2)")
                    .HasColumnName("horarioLabofinal");

                entity.Property(e => e.HorarioLaboinicial)
                    .HasColumnType("time(2)")
                    .HasColumnName("horarioLaboinicial");

                entity.Property(e => e.MetodoDeEnvioDeDatos).HasColumnName("metodoDeEnvioDeDatos");

                entity.Property(e => e.Pasos).HasColumnName("pasos");

                entity.Property(e => e.Permisos).HasColumnName("permisos");

                entity.Property(e => e.TimeSendDataGeoLocalization)
                    .HasColumnType("decimal(10, 2)")
                    .HasColumnName("timeSendDataGeoLocalization");
            ...
            modelBuilder.Entity<TicketRequerimiento>(entity =>
            {
                entity.HasKey(e => e.IdTicket)
                    .HasName("PK_ticketRequerimiento1_1");
            ...
            modelBuilder.Entity<Ticketresolucion>(entity =>
            {
                entity.HasKey(e => e.IdRequerimiento)
                    .HasName("PK_ticketresolucion1_1");
