...
namespace CMS_System.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController( cmsDb2024Context context ) {
            _context = context;
        }
        ...
        [HttpGet("ObtenerTecnicosAppMovil")]
        public async Task<IActionResult> ObtenerTecnicosAppMovil()
        {
            ...
            {
                return NotFound("No se encontraron técnicos con tipo 003.");
            }
