...
namespace CMS_System.Controllers
{
    ...
    public class RepuestosController : ControllerBase
    {
        ...
        public RepuestosController(cmsDb2024Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> guardarRepuestos([FromBody] Repuestos model)
        {
        ...
        public async Task<IActionResult> EditarMarcaRepuestos([FromRoute] int id, [FromBody] MarcaRepuestos model)
        {
        ...
        public async Task<IActionResult> GuardarMarcaRepuestos( [FromBody] MarcaRepuestos model )
        {
        ...
        private MarcaRepuestos validateDboExist(MarcaRepuestos model) => _context.MarcaRepuestos.FirstOrDefault(x => x.NombreMarcaRep == model.NombreMarcaRep);
        ...
        public async Task<IActionResult> EditarRepuestos([FromRoute] string codrep, [FromBody] Repuestos model)
        {
